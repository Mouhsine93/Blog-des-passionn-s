...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['id']) ? "../model/editCustomer.php" : "../model/addCustomer.php" ?>" method="post">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="cancelCustomer(<?= $value['id'] ?>)" style="color: red; cursor: pointer;"><i class='bx bx-stop-circle'></i></a>
                            </td>
                        </tr>
                <?php
                    }
...
<script>
function cancelCustomer(idCustomer) {
    if (confirm("Voulez-vous vraiment désactiver ce client ?")) {
        window.location.href = "../model/cancelCustomer.php?idCustomer=" + idCustomer;
    }
}
</script>
