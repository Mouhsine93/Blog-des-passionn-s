...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['id']) ? "../model/editSupplier.php" : "../model/addSupplier.php" ?>" method="post">
            ...
            <table class="mtable">
                ...
                ?>
                        ...
                        <td data-label='Nom'><?= $value['nom'] ?></td>
                            <td data-label='Prenom'><?= $value['prenom'] ?></td>
                            <td data-label='Telephone'><?= $value['telephone'] ?></td>
                            <td data-label='Adresse'><?= $value['adresse'] ?></td>
                            <td>
                                <a href="?id=<?= $value['id'] ?>"><i class='bx bx-edit-alt'></i></a>
                                <a onclick="cancelSupplier(<?= $value['id'] ?>)" style="color: red; cursor: pointer;"><i class='bx bx-stop-circle'></i></a>
                            </td>
                        </tr>
                <?php
                    }
...
<script>
function cancelSupplier(idFournisseur) {
    if (confirm("Voulez-vous vraiment désactiver ce fournisseur ?")) {
        window.location.href = "../model/cancelSupplier.php?idFournisseur=" + idFournisseur;
    }
}
</script>
